...
\pgfmathsetmacro{\torsoSizeX}{0.25}
\pgfmathsetmacro{\torsoSizeY}{0.45}
\pgfmathsetmacro{\torsoSizeZ}{0.3}

\pgfmathsetmacro{\torsoDiameter}{0.45}
\pgfmathsetmacro{\torsoRadius}{\torsoDiameter/2.}
...
\pgfmathsetmacro{\torsoPosZ}{\hipPosZ + \torsoSizeZ/2.}

\pgfmathsetmacro{\legPosYL}{\torsoSizeY/2.*\legRelativeAnchorY}
\pgfmathsetmacro{\legPosYR}{-\torsoSizeY/2.*\legRelativeAnchorY}
...
\draw(0, \torsoPosZ+\torsoSizeZ/2+0.05) node[anchor=south] {\textbf{Side view}};

% Torso
\rect{0}{\torsoPosZ}{\torsoSizeX}{\torsoSizeZ}
\cmpos{0}{\torsoPosZ}
...
\draw(0, \torsoPosZ+\torsoSizeZ/2+0.05) node[anchor=south] {\textbf{Front view}};

% Torso
\rect{0}{\torsoPosZ}{\torsoSizeY}{\torsoSizeZ}
\cmpos{0}{\torsoPosZ}
...
\draw (0,\torsoPosZ) node[anchor=center]{Torso};
