...
public:
	...
	*/
	static void addJointTorquesEquivalentToForce(const Character* character, KTJoint* start, const Point3d& pLocal, const Vector3d& fGlobal, KTJoint* end, JointTorques& torques);
