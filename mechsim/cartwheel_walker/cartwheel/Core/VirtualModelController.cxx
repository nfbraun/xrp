...
*/
void VirtualModelController::addJointTorquesEquivalentToForce(KTJoint* start, const Point3d& pLocal, const Vector3d& fGlobal, KTJoint* end, RawTorques& torques){
	...
	KTJoint* currentJoint = start;
	Vector3d tmpV;
	Point3d pGlobal = start->child->getWorldCoordinatesForPoint(pLocal);
