...
int main()
{
    ...
    dBodyID fBody3 = dBodyCreate(fWorld);
    dBodySetPosition(fBody3, 0., 0., -3.);
    dMassSetParameters(&mass, .9,            // total mass
                              0., 0., 0.,    // center of gravity
                              .5, .4, .3,    // I_11, I_22, I_33
                              0., 0., 0.);   // I_12, I_13, I_23
    dBodySetMass(fBody3, &mass);
    ...
    dJointID fJoint3 = dJointCreateUniversal(fWorld, 0);
    dJointAttach(fJoint3, fBody3, fBody2);
    dJointSetUniversalAnchor(fJoint3, 0., 0., -2.5);
    ...
    dBodySetLinearVel(fBody3, -3.*theta_0, 3.*phi_0, 0.);
    dBodySetAngularVel(fBody3, phi_0, theta_0, 0.);
    ...
    for(int t=0; t<10*STEP_PER_SEC; t++) {
        ...
        const double beta = dJointGetUniversalAngle1(fJoint3);
        const double gamma = dJointGetUniversalAngle2(fJoint3);
