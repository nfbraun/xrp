                     ...
                     adouble& time, adouble* xad, int iphase)
{
    ...
    return phi1*phi1 + phi2*phi2 + 100.*tau1*tau1 + 100.*tau2*tau2;
} 
         ...
         adouble* xad, int iphase)
{
    ...
    adouble b1 = mi11 * tau1 + mi12 * tau2;
    adouble b2 = mi21 * tau1 + mi22 * tau2;
...
////////////////////////////////////////////////////////////////////////////
    ...
    problem.name        		= "Acrobot2";
    problem.outfilename                 = "acrobot2.txt";
...
////////////////////////////////////////////////////////////////////////////
    ...
    problem.phases(1).bounds.lower.controls(2) = -5.;
    problem.phases(1).bounds.upper.controls(2) = 5.;
