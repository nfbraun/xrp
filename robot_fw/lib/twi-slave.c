...
SIGNAL(SIG_2WIRE_SERIAL)
{
    ...
    switch (TWSR)
    {
        ...
        case TWI_STX_ADR_ACK:
            // PRINT_DEBUG_P(PSTR("TWI_STX_ADR_ACK\n"));
            // Set buffer pointer to first data location
            TWI_bufPtr   = 0;
    
        // Data byte in TWDR has been transmitted; ACK has been received
        case TWI_STX_DATA_ACK:
            // PRINT_DEBUG_P(PSTR("TWI_STX_DATA_ACK\n"));
        ...
        case TWI_STX_DATA_NACK:           
            // PRINT_DEBUG_P(PSTR("TWI_STX_DATA_NACK\n"));
        ...
        case TWI_SRX_GEN_ACK:
            // PRINT_DEBUG_P(PSTR("TWI_SRX_GEN_ACK\n"));
            TWI_statusReg.genAddressCall = true;
        // Own SLA+W has been received ACK has been returned
        case TWI_SRX_ADR_ACK:            
            // PRINT_DEBUG_P(PSTR("TWI_SRX_ADR_ACK\n"));
    ...
    case TWI_SRX_ADR_DATA_ACK:
        // PRINT_DEBUG_P(PSTR("TWI_SRX_ADR_DATA_ACK\n"));
    case TWI_SRX_GEN_DATA_ACK:
        // PRINT_DEBUG_P(PSTR("TWI_SRX_ADR_DATA_ACK/TWI_SRX_GEN_DATA_ACK\n"));
        TWI_buf[TWI_bufPtr++] = TWDR;
        // PRINT_DEBUG_P(PSTR("Data: %d\n"), TWI_buf[TWI_bufPtr-1]);
    ...
    case TWI_SRX_STOP_RESTART:    
        // PRINT_DEBUG_P(PSTR("TWI_SRX_STOP_RESTART\n"));
        // Put TWI Transceiver in passive mode.
        TWCR = (1<<TWEN)|                          // Enable TWI-interface and release TWI pins
               (0<<TWIE)|(0<<TWINT)|               // Disable Interupt
               (0<<TWEA)|(0<<TWSTA)|(0<<TWSTO)|    // Do not acknowledge on any new requests.
